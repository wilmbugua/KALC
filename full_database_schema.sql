-- KALC POS Complete Database Schema
-- Based on Openbravo POS 2.30.1 + uniCenta oPOS 3.01 + KALC extensions
-- This file creates all tables, indexes, triggers, view and initial data

-- ============================================
-- 1. CORE TABLES (Openbravo / uniCenta)
-- ============================================
...
INSERT INTO APPLICATIONS(ID, NAME, VERSION) VALUES('kalc', 'KALC POS', '1.5.5');
...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', 'Administrator role', NULL);
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Manager role', NULL);
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Employee role', NULL);
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'Guest role', NULL);
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('0', 'Menu.Root', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('1', 'coin.2', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('2', 'coin.1', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('3', 'coin.50', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('4', 'coin.20', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('5', 'coin.10', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('6', 'coin.05', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('7', 'coin.02', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('8', 'coin.01', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('9', 'img.cash', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('10', 'img.cashdrawer', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('11', 'img.empty', 1, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('12', 'payment.cash', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('13', 'Printer.CloseCash', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('14', 'Printer.CustomerPaid', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('15', 'Printer.Inventory', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('16', 'Printer.OpenDrawer', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('17', 'Printer.PartialCash', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('18', 'Printer.Start', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('19', 'Printer.Ticket', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('20', 'Printer.Ticket2', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('21', 'Printer.TicketLine', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('22', 'Printer.TicketPreview', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('23', 'Printer.TicketTotal', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('24', 'Ticket.Buttons', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('25', 'Ticket.Close', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('26', 'Ticket.Discount', 0, NULL);
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('27', 'Ticket.Line', 0, NULL);
...
INSERT INTO TAXCUSTCATEGORIES(ID, NAME) VALUES ('000', 'Tax Exempt');
INSERT INTO TAXCUSTCATEGORIES(ID, NAME) VALUES ('001', 'Tax Standard');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'Tax Standard', '001', NULL, NULL, 0.16, FALSE, NULL);
...
INSERT INTO FLOORS(ID, NAME, IMAGE) VALUES ('0', 'Restaurant floor', NULL);
...
-- ============================================
-- 2. KALC-SPECIFIC TABLES
-- ============================================

CREATE TABLE TERMINALS (
    ID VARCHAR(255) NOT NULL,
    TERMINAL_NAME VARCHAR(255) NOT NULL,
    TERMINAL_KEY VARCHAR(255) PRIMARY KEY,
    TERMINAL_LOCATION VARCHAR(255),
    ACTIVE_CASH VARCHAR(255),
    ACTIVE_SESSION BOOLEAN,
    ACTIVE_USER VARCHAR(255),
    APPVERSION VARCHAR(255)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
CREATE UNIQUE INDEX TERMINALS_KEY_INX ON TERMINALS(TERMINAL_KEY);
...
CREATE INDEX DRAWEROPENED_INX_1 ON DRAWEROPENED(OPENDATE);

CREATE TABLE FOBLIST (
    FOBNUMBER VARCHAR(255) NOT NULL,
    CARDID VARCHAR(255) NOT NULL,
    PRIMARY KEY (FOBNUMBER)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
CREATE INDEX FOBLIST_INX_1 ON FOBLIST(CARDID);
...
INSERT INTO SEQUENCE (NAME, LASTVALUE) VALUES ('receipts', 0);
INSERT INTO SEQUENCE (NAME, LASTVALUE) VALUES ('tickets', 0);
INSERT INTO SEQUENCE (NAME, LASTVALUE) VALUES ('payments', 0);
INSERT INTO SEQUENCE (NAME, LASTVALUE) VALUES ('taxlines', 0);
INSERT INTO SEQUENCE (NAME, LASTVALUE) VALUES ('stockdiary', 0);
INSERT INTO SEQUENCE (NAME, LASTVALUE) VALUES ('closedcash', 0);
INSERT INTO SEQUENCE (NAME, LASTVALUE) VALUES ('sharedtickets', 0);
...
-- Uses single-statement syntax to avoid delimiter issues
...
-- Trigger: log ticketline inserts to stockdiary
...
-- Trigger: update stockcurrent after ticketline insert
...
-- ============================================
-- 5. ADDITIONAL KALC SETTINGS
-- ============================================

-- Insert default terminal if not exists
INSERT IGNORE INTO terminals (id, terminal_name, terminal_key, terminal_location)
VALUES ('1', 'DESKTOP-TOCBO9Q', 'unknown', 'Main Store');
...
-- Notes:
-- - This schema is based on Openbravo POS 2.30.1 + uniCenta oPOS 3.01.
-- - KALC-specific tables: terminals, drawopened, foblist, sequence.
-- - Trigers included: update_payments (protects payments table), 
--   basic stock management triggers (insert_ticketlines, update_stockcurrent_insert).
-- - The 'recipes' view is required by the application.
-- - More triggers (35+ total) may be needed for full KALC functionality.
--   Missing triggers (beyond these 3) should be added if features require them.

-- For a complete production database, obtain the full KALC POS DDL
-- from the official KALC Administration tools or vendor.
